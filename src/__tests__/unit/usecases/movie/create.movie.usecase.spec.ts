...
import { mockedCreateMovie, mockedCreatedMovie } from "@tests/__mocks__/movie/usecases/create.movie.use.case.mock";
...
describe('CreateMovieUsecase', () => {
    ...
    const mockCreateMovieUseCase = CreateMovieUseCase as jest.Mock<CreateMovieUseCase>
