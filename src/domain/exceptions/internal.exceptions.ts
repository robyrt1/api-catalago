...
export class EnvironmentVariableNotFound extends HttpException {
  constructor(envName: string) {
    super(
      {
        exception_code: ExceptionCodes.ENVIRONMENT_VARIABLE_NOT_FOUND,
        message: `environment var '${envName}' not found/not loaded.`,
      },
...
export class MissingFieldOrInvalidTypeException extends HttpException {
  constructor(message?: any) {
    super(
      {
        exception_code: ExceptionCodes.MISSING_FILED_OR_INVALID_TYPE,
        message,
      },
      HttpStatus.BAD_REQUEST,
    );
